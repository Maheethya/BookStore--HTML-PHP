...
<header>
<blockquote>
	<input class="hi" style="float: right; margin: 2%; font-size: 20px;" type="button" name="cancel" value="Home" onClick="window.location='index.php';" />
</blockquote>
</header>
<?php
session_start();
...
body {
            ...
            background-image: url('loging.jpg'); /* Add your image URL here */
